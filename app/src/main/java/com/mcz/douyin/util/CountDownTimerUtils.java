...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText(millisUntilFinished / 60 + "秒后可重新发送"); //设置倒计时时间
        mTextView.setBackgroundColor(R.color.gray); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundColor(R.color.green);//还原背景色
    }
}